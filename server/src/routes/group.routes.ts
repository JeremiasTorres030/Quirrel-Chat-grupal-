...
import { addMemberGroup, createGroup, deleteGroup, getAllGroups, getUnicGroup, allUserGroup, inviteMemberGroup, getMessagesGroup, deleteInvitationGroup, exitGroup, editGroup } from '../controllers/group.controllers'
...
router.post('/api/group/new',
  check('groupname', 'El nombre del grupo es obligatorio').isString(),
  validarCampos,
  createGroup)

router.delete('/api/group/delete/:id', deleteGroup)
...
router.delete('/api/group/member/invite/denied/:uid/:gid', deleteInvitationGroup)
